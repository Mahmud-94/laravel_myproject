...
<h3><p class="card-title"> contact details :</p> </h3>
  <img src="{{asset($contact->photo)}}" width="300px" class="card-img-top" alt="...">
  <div class="card-body">

    <p class="card-text"><strong>Name :</strong> {{$contact->name}}</p>
    <p class="card-text"><strong>Email :</strong> {{$contact->email}}</p>
    <p class="card-text"><strong>Contact No :</strong> {{$contact->phone}}</p>
